...
var hamment = document.querySelector("#menu");
var navbar_list = document.querySelectorAll(".navbar__list");
var anchor_reservationPage = document.querySelectorAll("*[data-path=\"reservation\"]");
var anchor_reservationPage_level = document.querySelectorAll("*[data-path=\"reservation-level\"]"); // window.addEventListener('resize',function () {
...
var intro_swiper = new Swiper('.intro-scroller', {
  // Default parameters
  breakpoints: {
    // when window width is >= 380px
    320: {
